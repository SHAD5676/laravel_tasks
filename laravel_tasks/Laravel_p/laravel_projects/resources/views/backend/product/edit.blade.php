            ...
            <div class="col-sm-12 col-lg-4">
                <div class="card ">
                    <div class="card-body">
                        ...
                        <from method="post" action="{{route(')category.update',$category->id)}}">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <label for="exampleInputEmail">Category Nmae</label>
                                <input type="text" name="cat_name" value="{{!old('cat_name')? $category->name:old('cat_name') }}" class="form-control>"
                                id="exampleInputEmail" placeholder="Category Name">
                                 </div>
