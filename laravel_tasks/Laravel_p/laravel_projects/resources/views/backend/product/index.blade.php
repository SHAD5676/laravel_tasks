            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Product List <span class="pull-right">
                                <a href="{{route('product.create')}}" class="btn btn-info">New Category</a>
                            </span></h4>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <form method="post" action="{{route('product.destroy',$item->id)}}" enctype="multipart/form-data">
                                            @csrf
                                            @method('delete')
